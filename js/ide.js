...
public class Hello {\n\
    public static void Main() {\n\
        System.Console.WriteLine(\"Welcome to Coding Test\");\n\
    }\n\
}\n\
";
...
\n\
int main() {\n\
    std::cout << \"Welcome to Coding Test\" << std::endl;\n\
    return 0;\n\
}\n\
";
...
public class Main {\n\
    public static void main(String[] args) {\n\
        System.out.println(\"Welcome to Coding Test\");\n\
    }\n\
}\n\
";

var javaScriptSource = "console.log(\"Welcome to Coding Test\");";

var kotlinSource = "\
fun main() {\n\
    println(\"Welcome to Coding Test\")\n\
}\n\
";
...
var pythonSource = "print(\"Welcome to Coding Test\")";
